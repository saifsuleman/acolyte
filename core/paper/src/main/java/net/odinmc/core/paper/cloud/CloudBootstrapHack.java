...
public class CloudBootstrapHack {
    ...
    public CloudBootstrapHack() {
        ...
        instantLifecycleManager = new LifecycleEventManager<BootstrapContext>() {
            @Override
            public <E extends LifecycleEvent> void registerEventHandler(LifecycleEventType<? super BootstrapContext, ? extends E, ?> eventType, LifecycleEventHandler<? super E> eventHandler) {
