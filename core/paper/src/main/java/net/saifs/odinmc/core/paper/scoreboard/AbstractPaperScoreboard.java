...
public abstract class AbstractPaperScoreboard implements PaperScoreboard {
  ...
  @Override
  public PaperScoreboardObjective newPlayerObjective(Player player, String name, Component title, String criteria, DisplaySlot slot, NumberFormat styledFormat) {
    var objectives = playerObjectives.get(player);
    if (objectives == null) {
  ...
  protected abstract AbstractPaperScoreboardObjective buildObjective(String name, Component title, String criteria, DisplaySlot slot, NumberFormat styledFormat);
